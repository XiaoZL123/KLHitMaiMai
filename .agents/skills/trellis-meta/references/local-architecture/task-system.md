...
```bash
py -3 ./.trellis/scripts/task.py create "<child title>" --description "<one-line summary>" --slug <child-slug> --parent <parent-dir>
```

Link or unlink existing tasks with:

```bash
py -3 ./.trellis/scripts/task.py add-subtask <parent-dir> <child-dir>
py -3 ./.trellis/scripts/task.py remove-subtask <parent-dir> <child-dir>
```
...
```bash
py -3 ./.trellis/scripts/task.py create "<title>" --description "<one-line summary>" --slug <slug>
